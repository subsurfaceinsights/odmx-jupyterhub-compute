...
#c.LDAPAuthenticator.server_address = '10.158.0.1'
#c.LDAPAuthenticator.tls_strategy = 'insecure'
##c.LDAPAuthenticator.use_ssl = False
#c.LDAPAuthenticator.bind_dn_template = 'cn={username},ou=users,dc=subsurfaceinsights,dc=com'
...
#import os
#notebook_dir = os.environ.get('DOCKER_NOTEBOOK_DIR') or '/home/joyvan/work'
#c.DockerSpawner.notebook_dir = notebook_dir
#c.DockerSpawner.volumes = { 'jupyterhub-user-{username}': notebook_dir }

# Use our custom image
c.DockerSpawner.image = 'subsurfaceinsights/jupyterhub-singleuser'
